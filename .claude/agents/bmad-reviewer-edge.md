---
name: bmad-reviewer-edge
description: BMAD review layer — Edge Case Hunter. Reads the skill's edge-case-hunter prompt and applies it to a diff. Invoked only by BMAD review steps; not for general use.
tools: Read
model: sonnet
---
