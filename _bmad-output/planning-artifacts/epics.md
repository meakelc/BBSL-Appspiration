...
**And** **45 is the one that stops this being built as a flat rule**: a demotion that *lowers* Cap Space and *raises* Maximum Bid by $11,000,000 is the case a naive implementation gets backwards
